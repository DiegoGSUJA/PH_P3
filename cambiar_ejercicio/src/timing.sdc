...
create_generated_clock -name pixel_clk -source [get_ports {clk}] -master_clock sys_clk -multiply_by 11 -divide_by 4 [get_pins {ej_p/clk_pixel/clkdiv_inst/CLKOUT}]

# 3. False Paths (Ignorar chequeos de tiempo en señales asíncronas o pines físicos diferenciales)
set_false_path -from [get_ports {boton_izq}]
